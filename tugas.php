  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="customer" name="cs" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="produk" id="produk" type="radio" class="custom-control-input" value="tv"> 
    ...
    <div class="offset-4 col-8">
      <button name="submit" type="submit" class="btn btn-primary">Submit</button>
            ...
            <div class="col-3">
                ...
                <li class="list-group-item active" aria-current="true">Harga dapat berubah setiap waktu !!!</li>
                </ul>
            </div>
        </div>
    </div>
